...
- "Where should I create this skill? If you do not have a preference, I will place it in `$AGENTS_HOME/skills` (or `~/.agents/skills` when `AGENTS_HOME` is unset) so agents can discover it automatically."
